...
- One 3-pin slide switch
- One 100uF electrolytic capacitor
- Two 104 ceramic capacitors
- Battery pack / external power source
...
- Do not install propellers during the first wiring and direction tests.
- Disconnect the battery before changing wiring.
- Do not short the VCC and GND rails.
- If the motor driver, motors, wires, or battery become hot, disconnect power immediately.
- Keep the 100uF electrolytic capacitor polarity correct.
- Keep the ESP32-C3 `3V3` pin away from the main motor power rail.
